package au.csiro.gsnlite.storage.db;
...
public class H2StorageManager extends StorageManager {
    ...
    private static String TAG = "H2StorageManager.class";
    ...
    public byte convertLocalTypeToGSN(int jdbcType, int precision) {
        switch (jdbcType) {
                    ...
                    default:
                        logger.error(TAG,"The type can't be converted to GSN form : " + jdbcType);
                        break;
                }
                return -100;
    }
    ...
    public void shutdown() throws SQLException {
        ...
        logger.warn(TAG,"Closing the database server (for HSqlDB) [done].");
