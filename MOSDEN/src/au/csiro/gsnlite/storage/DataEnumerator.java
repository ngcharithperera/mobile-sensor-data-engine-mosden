...
public class DataEnumerator implements DataEnumeratorIF {
	  ...
	  private static String TAG = "DataEnumerator.class";
	...
	public DataEnumerator ( StorageManager storageManager, PreparedStatement preparedStatement , boolean binaryLinked ,boolean manualClose) {
		...
		if ( preparedStatement == null ) {
			if ( logger.isDebugEnabled( ) ) logger.debug (TAG, new StringBuilder( ).append( "resultSetToStreamElements" ).append( " is supplied with null input." ).toString( ) );
			hasNext = false;
			return;
		}
...
//		}
		...
		try {
			...
			logger.error (TAG,"Trying to create DataEnumerator with:\n"+preparedStatement.toString());
